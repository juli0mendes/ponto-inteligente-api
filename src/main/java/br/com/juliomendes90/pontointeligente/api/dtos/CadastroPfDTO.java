package br.com.juliomendes90.pontointeligente.api.dtos;
...
public class CadastroPfDTO {
	...
	@Length(min = 5, max = 200, message = "Email deve ter conter entre 5 e 200 caracteres")
	...
	@NotNull(message = "Senha não pode vazio")
